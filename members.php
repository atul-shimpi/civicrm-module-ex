...
function members_civicrm_install() {
  return _members_civix_civicrm_install();
}
...
function members_civicrm_uninstall() {
  return _members_civix_civicrm_uninstall();
}
...
function members_civicrm_enable() {
  return _members_civix_civicrm_enable();
}
...
function members_civicrm_disable() {
  return _members_civix_civicrm_disable();
}
...
function members_civicrm_managed(&$entities) {
  return _members_civix_civicrm_managed($entities);
}
 ...
 * @param $angularModule
 */
function members_civicrm_angularModules(&$angularModule) {
  $angularModule['members'] = array(
    'ext' => 'org.civicrm.members',
    'js' => array('js/*.js'),
